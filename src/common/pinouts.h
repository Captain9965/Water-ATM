...
#define SYSTEM_GSM_POWER_KEY                PB1
...
#define SYSTEM_QUANTITY_4                   PD2
#define SYSTEM_QUANTITY_5                   PB3
#define SYSTEM_QUANTITY_6                   PB4
#define SYSTEM_DOORSWITCH                   PB5
#define SYSTEM_TAP_1                        PC9
#define SYSTEM_TAP_2                        PC8
#define SYSTEM_TAP_3                        PC7
#define SYSTEM_TAP_4                        PC6
#define SYSTEM_SOLENOID_VALVE_1             PA8
#define SYSTEM_SOLENOID_VALVE_2             PA11
#define SYSTEM_SOLENOID_VALVE_3             PA12
#define SYSTEM_SOLENOID_VALVE_4             PB8
#define SYSTEM_SOLENOID_INTERRUPT_1         PB12
#define SYSTEM_SOLENOID_INTERRUPT_2         PB13
